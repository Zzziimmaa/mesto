...
const cardCloseButton = document.querySelector('.popup_close-card'); // кнопка открытия попапа добаления картинок
...
const popupImgClose = document.querySelector('.popup_close-img'); //кнопка закрытия попапа с картинкой
